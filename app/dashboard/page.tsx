                ...
                >
                  ...
                  <div className="px-4 pt-3 pb-2.5 border-b border-gray-100 flex items-center gap-2.5">
                    {isOwnListing ? (
                      <>
                        {listing.user_profile_picture ? (
                          <Image
                            src={
                              getImageUrl(listing.user_profile_picture) || ""
                            }
                            alt="You"
                            width={28}
                            height={28}
                    ...
                    {listing.kyc_verified && (
                      <span
                        className="flex-shrink-0 inline-flex items-center justify-center w-4 h-4 bg-blue-100 rounded-full"
                        title="KYC Verified"
                      >
                        <svg
                    ...
                    {listing.user_is_suspended && (
                      <span className="ml-auto flex-shrink-0 text-xs font-semibold bg-red-100 text-red-600 px-2 py-0.5 rounded-full">
                        Suspended
                      </span>
                    )}
                  </div>
                  ...
                  <div className="p-4 flex flex-col flex-1 gap-2.5">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-400 gap-1 border-t border-gray-50 pt-2">
                      ...
                      <span
                        className={`flex-shrink-0 ${timeInfo.isNew ? "text-blue-500 font-semibold" : ""}`}
                      >
                        {timeInfo.text}
                      </span>
                    </div>
