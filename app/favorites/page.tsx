    ...
    <div className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="bg-white sticky top-0 z-20 shadow-[0_1px_0_0_#e5e7eb]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3 pt-4 pb-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400 mt-0.5 leading-none">
                {favorites.length} seller{favorites.length !== 1 ? "s" : ""}
                &nbsp;&middot;&nbsp;{wishlist.length} wishlisted
              </p>
            </div>
          </div>
          ...
          {/* Tab row */}
          <div
            className="flex overflow-x-auto gap-0 -mx-4 px-4 sm:mx-0 sm:px-0"
          ...
          >
            {(
                  ...
                  icon: (
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M17 20h5v-2a4 4 0 00-5-3.87M9 20H4v-2a4 4 0 015-3.87m7-5a4 4 0 11-8 0 4 4 0 018 0z"
                      />
                    </svg>
                  ),
                },
              ...
              >
                <span
                  className={
                    activeTab === tab.key ? "text-amber-500" : "text-gray-400"
                  }
                >
                  {tab.icon}
                </span>
                      ...
                      <div className="sm:hidden flex items-center gap-2 mt-4 pt-3 border-t border-gray-50">
                        ...
                        >
                          <svg
                            className="w-4 h-4"
                            fill={
                              fav.notify_new_listings ? "currentColor" : "none"
                            }
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            strokeWidth={2}
                        ...
                        <button
                          onClick={() =>
                            router.push(`/chat?userId=${fav.favorite_user_id}`)
                          }
                          ...
                          {listing.last_seen_price !== null &&
                            Number(listing.last_seen_price) !==
                              ...
                              <span className="text-xs text-gray-400 line-through">
                                {Number(listing.last_seen_price).toLocaleString(
                                  "en-US",
                                )}
                              </span>
                            )}
