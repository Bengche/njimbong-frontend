        ...
        <div className="px-5 pt-4 pb-6 sm:px-6 sm:py-6">
          ...
          <div className="flex gap-2.5 bg-amber-50 border border-amber-200 rounded-xl p-3.5 mb-5">
            ...
            <p className="text-amber-800 text-xs leading-relaxed">
              ...
              Once confirmed, the payment will be instantly released to the
              seller and cannot be reversed.
            </p>
          </div>
          {/* Checklist */}
...
function ReleaseSuccessOverlay({
  ...
  const progress = Math.round(
    ((REDIRECT_SECS - countdown) / REDIRECT_SECS) * 100,
  );
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6 bg-gradient-to-br from-emerald-950 via-emerald-900 to-green-900">
      <div className="w-full max-w-xs text-center select-none">
        ...
        <div className="relative flex items-center justify-center mb-8">
          <div
            className="absolute w-32 h-32 rounded-full bg-emerald-400/20 animate-ping"
        ...
        <p className="text-emerald-400/70 text-xs mb-8 leading-relaxed">
          Your transaction is complete. Thank you for using
          <br />
