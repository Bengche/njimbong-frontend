    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-yellow-50 to-white text-gray-900">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14 md:py-20">
        ...
        <section className="grid gap-10 md:grid-cols-2 md:items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl font-bold leading-tight tracking-tight md:text-5xl">
              ...
              <span className="text-emerald-600">Your Money is Always Protected.</span>
            </h1>
            <p className="text-lg text-gray-600 leading-relaxed">
              ...
              payment is held safely until you confirm you have received your item.
            </p>
          ...
          <div className="rounded-2xl bg-white shadow-xl border border-emerald-100 overflow-hidden">
            <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-white text-sm">Secure Payments — Powered by Fonlok</p>
                  <p className="text-emerald-100 text-xs">Your money is held safely until delivery is confirmed</p>
                </div>
              </div>
            </div>
            <div className="p-6 space-y-4">
              {[
                { step: "1", label: "You pay into escrow", detail: "Your MoMo payment is locked securely — not released to the seller yet." },
                { step: "2", label: "Seller delivers the item", detail: "The seller knows payment is guaranteed. They ship or hand over the item." },
                { step: "3", label: "You confirm receipt", detail: "Once you confirm everything is as described, funds are released to the seller." },
              ].map((s) => (
            ...
            <div className="px-6 py-10 sm:px-10 sm:py-14 md:grid md:grid-cols-2 md:gap-12 md:items-center">
              ...
              <div className="text-white space-y-6">
                ...
                <h2 id="escrow-section" className="text-3xl font-bold leading-tight">
                  Your money stays safe.<br/>
                  <span className="text-emerald-300">Every single time.</span>
                </h2>
                <p className="text-emerald-100 leading-relaxed text-sm sm:text-base">
                  Fonlok is Cameroon&apos;s dedicated escrow payment platform. When you buy on Njimbong,
                  your MoMo payment is locked in a secure vault — invisible to the seller until you
                  confirm you&apos;ve received your item exactly as described.
                </p>
        ...
        <section className="mt-16 grid gap-10 md:grid-cols-2" aria-labelledby="categories">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              and more. Whether you&apos;re shopping locally or selling nationwide,
              every listing is moderated and every XAF payment is escrow-secured.
            </p>
            ...
            <p className="text-sm text-gray-500">
              Explore more on the{" "}
              <a className="text-emerald-700 hover:underline font-medium" href="/dashboard">marketplace</a>{" "}
              or list your first item from your{" "}
              <a className="text-emerald-700 hover:underline font-medium" href="/dashboard">seller dashboard</a>.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-emerald-700 p-8 text-white shadow-xl">
            ...
            <p className="mt-3 text-sm text-emerald-100 leading-relaxed">
              Every tool on Njimbong is designed around a single principle: your safety.
              From KYC verification and escrow payments to moderation and disputes,
              we have you covered at every step.
            </p>
        ...
        <section className="mt-16" aria-labelledby="how-it-works">
          <div className="mb-8">
            <h2 id="how-it-works" className="text-2xl font-bold">How Njimbong Works</h2>
            <p className="mt-2 text-gray-600">From signup to a completed secure deal — four steps.</p>
          </div>
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { step: "1", title: "Create your account", text: "Sign up for free, verify your profile, and build trust with buyers and sellers.", link: "/signup", linkText: "Get started" },
              { step: "2", title: "Find or post a listing", text: "Browse thousands of listings or post your own item in under two minutes.", link: "/browse", linkText: "Browse now" },
              { step: "3", title: "Chat safely on-platform", text: "Negotiate details, ask questions, and agree a price — all within Njimbong's secure chat.", link: "/chat", linkText: "Open chat" },
              { step: "4", title: "Pay via escrow & confirm", text: "Pay with MoMo through Fonlok escrow. Your money is released only when you say so.", link: "/safety-trust", linkText: "Learn more" },
            ].map((item) => (
              <div key={item.step} className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow relative overflow-hidden">
                ...
                <div className="text-xs font-semibold text-emerald-600 mb-2">Step {item.step}</div>
        ...
        <section className="mt-16 rounded-3xl bg-white p-8 sm:p-12 shadow-xl border border-emerald-100 text-center">
          ...
          <h2 className="text-2xl font-bold sm:text-3xl">Join Njimbong Today</h2>
          <p className="mt-3 text-gray-600 max-w-lg mx-auto text-sm sm:text-base leading-relaxed">
            Buy and sell online with complete peace of mind. Every XAF payment is
            protected by Fonlok escrow — your money only moves when you say so.
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs text-gray-500">
            {["Free to sign up", "Escrow-protected payments", "KYC-verified sellers", "Dispute resolution included"].map((item) => (
          ...
          <p className="mt-4 text-xs text-gray-400">
            Already a member?{" "}
            <a className="text-emerald-700 hover:underline font-medium" href="/login">Sign in</a>{" "}
            · Need help?{" "}
