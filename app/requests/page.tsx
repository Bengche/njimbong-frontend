...
function RequestCard({
  ...
  return (
    <article
      className={`bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden flex flex-col group${isFulfilled ? " opacity-80" : ""}`}
    >
      {/* Top accent bar */}
      <div
